...
export class UnitNormalizationService {
  ...
  private readonly unitMap: Record<
    string,
    { category: PhysicalUnitCategory; baseFactor: number; canonicalSymbol: string }
  > = {
    // ── Volume ──
    ...
    us_gallon: { category: 'VOLUME', baseFactor: 3.785411784, canonicalSymbol: 'l' },
    gallon_us: { category: 'VOLUME', baseFactor: 3.785411784, canonicalSymbol: 'l' },
    gallon: { category: 'VOLUME', baseFactor: 3.785411784, canonicalSymbol: 'l' },
    gallons: { category: 'VOLUME', baseFactor: 3.785411784, canonicalSymbol: 'l' },
    uk_gallon: { category: 'VOLUME', baseFactor: 4.54609, canonicalSymbol: 'l' },
    gallon_uk: { category: 'VOLUME', baseFactor: 4.54609, canonicalSymbol: 'l' },
    m3: { category: 'VOLUME', baseFactor: 1000.0, canonicalSymbol: 'l' },
    cubic_metre: { category: 'VOLUME', baseFactor: 1000.0, canonicalSymbol: 'l' },
    cubic_meter: { category: 'VOLUME', baseFactor: 1000.0, canonicalSymbol: 'l' },
    ...
    metric_tonne: { category: 'MASS', baseFactor: 1000.0, canonicalSymbol: 'kg' },
    ...
    short_ton: { category: 'MASS', baseFactor: 907.18474, canonicalSymbol: 'kg' },

    // ── Energy ──
    kwh: { category: 'ENERGY', baseFactor: 1.0, canonicalSymbol: 'kWh' },
    kilowatt_hour: { category: 'ENERGY', baseFactor: 1.0, canonicalSymbol: 'kWh' },
    mwh: { category: 'ENERGY', baseFactor: 1000.0, canonicalSymbol: 'kWh' },
    megawatt_hour: { category: 'ENERGY', baseFactor: 1000.0, canonicalSymbol: 'kWh' },
    gwh: { category: 'ENERGY', baseFactor: 1000000.0, canonicalSymbol: 'kWh' },
    gj: { category: 'ENERGY', baseFactor: 277.777778, canonicalSymbol: 'kWh' },
    gigajoule: { category: 'ENERGY', baseFactor: 277.777778, canonicalSymbol: 'kWh' },
    mj: { category: 'ENERGY', baseFactor: 0.277778, canonicalSymbol: 'kWh' },
    megajoule: { category: 'ENERGY', baseFactor: 0.277778, canonicalSymbol: 'kWh' },
    ...
    miles: { category: 'DISTANCE', baseFactor: 1.609344, canonicalSymbol: 'km' },
    ...
    'tonne-km': { category: 'FREIGHT', baseFactor: 1.0, canonicalSymbol: 't-km' },
    'ton-miles': { category: 'FREIGHT', baseFactor: 1.459972, canonicalSymbol: 't-km' },
    'ton-mile': { category: 'FREIGHT', baseFactor: 1.459972, canonicalSymbol: 't-km' },
  };

  private cleanUnitKey(unit: string): string {
    return (unit || '').toLowerCase().trim().replace(/[\s\-_]+/g, '_');
  }
  ...
  normalizeUnit(
    ...
    const normalizedAmount = Number(
      (rawAmount * conversionFactor).toFixed(6),
    );
