...
import { MasterEntity } from 'src/entities/master-entity.entity';
import { MasterEntityRelationship } from 'src/entities/master-entity-relationship.entity';
import { MasterSchemaDefinition } from 'src/entities/master-schema-definition.entity';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([
      ...
      UnitFormulaMapping,
      MasterEntity,
      MasterEntityRelationship,
      MasterSchemaDefinition,
    ]),
  ],
  controllers: [MasterController],
  providers: [MasterService, EmissionFactorService, UtilService],
  exports: [MasterService, EmissionFactorService],
})
